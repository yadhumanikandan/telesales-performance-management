...
import { useAgentSubmissions, SubmissionPeriod, BANK_GROUPS } from '@/hooks/useAgentSubmissions';
import { Calendar, ClipboardList, Trash2, AlertTriangle } from 'lucide-react';
...
export const SubmissionsTable: React.FC = () => {
  ...
  const getGroupBanks = (group: string) => {
    if (group === 'group1') return BANK_GROUPS.group1.join(', ');
    if (group === 'group2') return BANK_GROUPS.group2.join(', ');
    return '';
  };
